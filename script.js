...
function startStory(audioMap) {
  ...
  const storyContainer = document.querySelector(".story-container");
    ...
    const storyData = [
      ...
      { text: "Bukan lagi duduk di ruang tunggu, tetapi duduk di kursi penumpang mobil yang terletak tepat di belakang kursi pengemudi. Otot pada iris mata Akiko membesarkan pupilnya, terang di ruang tunggu tadi berubah menjadi gelapnya badai di malam hari.", audio: "thunder", volume: 0.8},
      { text: "." , align: "center"},
      { text: ".", align: "center" },
      { text: "." , align: "center"},
      ...
      { text: "." , align: "center"},
      { text: "Di dalam mobil sedan itu, Akiko tidak dapat melakukan apa-apa. Tidak dapat membuka pintu, tidak dapat meneriaki ayahnya untuk membanting setir ke kiri—dan bukan ke kanan, tidak dapat menyuruh ibunya untuk menurunkan sandaran kursi sehingga ia bisa terhindar dari batang pohon yang menerobos masuk dari kaca bagian depan mobil.", audio: "break"},
      { text: "Maka, untuk yang kesekian kalinya, Akiko menyaksikan wanita yang melahirkannya kehilangan nyawa di tempat. Batang pohon tebal itu  menabrak kepala sang ibu, membuat dagunya terangkat bersamaan dengan nyawanya. Untuk beberapa jam, kepala wanita itu terimpit antara batang pohon dan sandaran kursi penumpang. Sang suami dan anaknya selalu berpikir, andai mereka tidak kehilangan kesadaran sejenak di malam itu, mungkin leher yang patah itu masih dapat diselamatkan.", audio: "choke"},
      { text: "Akiko sudah hafal dengan mimpi ini, ia tak lagi menangis atau berkeringat berlebihan ketika mengalami mimpi ini. Akiko sadar bahwa dia sedang bermimpi, dia pun sudah pernah melewati hal yang lebih mengerikan—kenyataan. Sorot matanya berpindah dari kepala ayahnya yang menabrak kemudi, kini menuju kepala ibunya yang sudah tidak berbentuk. \"Ibu tetap tampak cantik meski sudah sehancur ini.\"", audio: "squelch"},
      { text: "Tiba-tiba, sandaran kursi ibunya turun, diikuti oleh tubuh wanita itu yang kini tengah berbaring di kursi penumpangnya. Wajahnya menghadap Akiko—membuat putrinya dapat melihat hidung bengkok, rahang miring, retakan tulang pipi yang mencuat keluar dari kulit, serta darah yang menghiasi keindahan pesonanya."},
      { text: "Isak Akiko memecah saat doanya dikabulkan, ia akhirnya dapat melihat wajah ibunya lagi meski tetap harus melalui kecelakaan itu kembali. Akiko membawa wajahnya mendekati jasad ibunya, napasnya tercekat waktu ia merasa tangan yang halus membelai surainya. Genangan air di pelupuk matanya langsung tumpah. \"Ibu? Ibu rindu aku?\""},
      { text: "Wanita dengan kedua mata yang tertutup itu tak menjawab, hanya menggerakan tangannya turun ke tengkuk anaknya."},
      ...
      { text: "Akiko mematung di sudut kamar, tubuhnya merosot ke lantai setelah mendengar kalimat terakhir Nanami. Tangan Akiko masih menggenggam kunci kamar dengan gantungan bergambar penyanyi kesukaannya, seakan kunci itu mungkin terbang dengan sendirinya ke lubang di pintu secara tiba-tiba. Napasnya menderu bersamaan dengan batuknya yang tak kunjung pergi.", audio: "breath2"},
